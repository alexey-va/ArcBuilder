    ...
    companion object {
        ...
        private val MESSAGE_REQUIREMENTS = LocaleRequirements(
            scalarPaths = setOf(
                ...
                "construction.instant-started",
                "construction.cancel-requested",
                "construction.cancelled",
                "construction.recovery-required",
                "construction.status",
                "construction.projects.menu.title",
                "construction.projects.menu.world-unavailable",
                "construction.projects.menu.card.name",
                "construction.projects.menu.card.teleport",
                "construction.projects.menu.card.teleport-unavailable",
                "construction.projects.menu.reasons.waiting-materials",
                "construction.projects.menu.reasons.waiting-output",
                "construction.projects.menu.reasons.paused",
                "construction.projects.menu.reasons.recovery",
                "construction.projects.menu.reasons.working",
                "construction.projects.menu.empty.name",
                "construction.projects.menu.previous.name",
                "construction.projects.menu.close.name",
                "construction.projects.menu.next.name",
                "construction.projects.teleport.success",
                "construction.projects.teleport.missing",
                "construction.projects.teleport.world-unavailable",
                "construction.projects.teleport.unsafe",
                "construction.projects.teleport.failed",
                ...
                "construction.site.menu.instant.name",
                "construction.site.menu.cancel.name",
                "construction.site.menu.cancel-confirm.name",
                "items.none",
                "items.summary",
                "status.selection",
                ...
                "book.preview-menu.placement.away.name",
            ...
            listPaths = setOf(
                ...
                "construction.site.menu.instant.lore",
                "construction.site.menu.cancel.lore",
                "construction.site.menu.cancel-confirm.lore",
                "construction.projects.menu.card.lore",
                "construction.projects.menu.empty.lore",
                "construction.projects.menu.previous.lore",
                "construction.projects.menu.close.lore",
                "construction.projects.menu.next.lore",
                "book.preview-menu.placement.left.lore",
                "book.preview-menu.placement.away.lore",
